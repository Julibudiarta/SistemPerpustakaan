...
<!DOCTYPE html>
    <html lang="en">
      ...
      <body>
        ...
        <div class="jumbotron mt-5" id="main-content3">
          <div class="container">
            <div class="row">
              <div class="col-lg-6 mt-5">
                <img src="../aset/admin1.png" alt="Gambar Jumbotron" class="img-fluid">
              </div>
              <div class="col-lg-6">
                <h1 class="display-4 mt-5">Hello Admin</h1>
                <p class="lead">Buku adalah sumber ilmu, buku adalah sumber pengetahuan, dengan membaca buku kamu dapat mencerahkan hidupmu</p>
                <hr class="my-4">
